...
function setting(req,res,next){
	console.log("jkufhsdufsdfnfsdkjfn")
	// console.log("dejkjnfjknjk");
					...
					Users.getByName(userName,function(error,user){
					    ...
					    if (user) {
					      	ep.emit("setting_error","userName","Name had been registered"); 
								...
								console.log("I am " + userInterests)
								console.log("I am " + userSkills)
								originalUser.skills = userSkills;
								originalUser.interests = userInterests;
...
function sendActiveEmail(user){
	...
	var subject = "Active Email from TechAlchemy";
	var html = "<p>Wellcome to TechAlchemy </p><p>This is your active url : "+activeUrl+" </p>";
